...
Rscript plot_binding_specificity_comparison.R out/binding-specificities-with-adapt-predictions.tsv.gz out/plots/binding.scatter.pdf out/plots/binding.quartiles.pdf out/plots/binding.scatter.decrease.pdf &> out/plots/binding.out
